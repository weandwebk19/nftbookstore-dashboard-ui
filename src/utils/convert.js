...
export const convertArrayToHexString = function (array) {
  return array
    .map((value) => {
...
export const convertHexStringToUint8Array = function (hexString) {
  if (hexString) {
...
export const convertHexStringToUint32Array = function (hexString) {
